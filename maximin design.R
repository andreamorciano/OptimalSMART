...
maximin_design <- function(gamma1, gamma2, Ca = 10, Cb = 10, Cc =10, Cd = 10, Ce = 10, Cf = 10,
                           Cg = 10, Ch = 10, 
                           w13 = 0.25, w14 = 0.25, w23 = 0.25, w24 = 0.25, C = 100000, stepsize = 0.05){
time_in <- Sys.time()
...
mmd_value <- mmd_value %>% dplyr::transmute(gamma1 = gamma1, gamma2 = gamma2, Ca = Ca, Cb = Cb, Cc = Cc, Cd = Cd,
                                            Ce = Ce, Cf = Cf, Cg = Cg, Ch = Ch, p1_mmd = p1_mmd, 
                               p2_mmd = p2_mmd, p3_mmd = p3_mmd, N_mmd = N_mmd, fun = round(fun, 5), Cost = Cost, MMV = MMV,
                               w13 = w13, w14 = w14, w23 = w23, w24 = w24)

colnames(mmd_value) <- c(paste0(intToUtf8(947),c(1:2)," Range"), "Ca", "Cb", "Cc", "Cd", "Ce", "Cf", "Cg", "Ch",
